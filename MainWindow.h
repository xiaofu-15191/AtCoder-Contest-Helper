...
const QString RatingNumColorStyleSheet[]={"QToolTip{color:rgb(255,255,255);background-color:rgb(128,128,128)}",
...
private:
	...
	QNetworkReply *UserInformationReply,*AvatarReply;
	QString UserName;
	/*QChart *RatingChart;
